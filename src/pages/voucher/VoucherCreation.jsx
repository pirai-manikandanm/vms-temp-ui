...
const VoucherCreation = () => {
        ...
        useEffect(() => {
                const creationType = location?.state?.type || VOUCHER_CREATION_TYPE.SINGLIFE;
        ...
        const buildVoucherJson = (values) => {
                ...
                const promoConfig = {
                        ...
                        voucherConfig: {
                                ...
                                category: "G",
                                classification: values?.classification || CLASSIFICATION_TYPE?.[0]?.value,
                                ...
                                <div className="mx-auto rounded-3xl  px-10 backdrop-blur-xl md:p-7 w-full">
                                        ...
                                        >
                                                <div className="flex flex-col gap-3 bg-red-500 p-5 text-white md:flex-row md:items-center md:justify-between">
                                                        <div>
                                                                <h1 className="text-xl font-bold md:text-2xl">Voucher Configuration</h1>
                                                                <p className="text-sm text-white/90">
                                                                        Compact single-view setup for series, promo, and voucher details
                                                                </p>
                                                        </div>
                                                ...
                                                <div className="bg-white p-4 border border-slate-100">
                                                        ...
                                                        <div className="flex flex-wrap gap-x-4">
                                                                ...
                                                                <InputField
                                                                        ...
                                                                        name="type"
                                                                        type="select"
                                                                        defaultValue={PROMO_TYPE?.[0]?.value}
                                                                        options={PROMO_TYPE}
                                                                        getValue={true}
                                                ...
                                                <div className="bg-white p-4 border border-slate-100">
                                                        ...
                                                        <div className="flex flex-wrap gap-x-4">
                                                                <InputField
                                                                        label="Series Code"
                                                                        name="seriesCode"
                                                                        rules={[{ required: true, message: "Please enter the series code" }]}
                                                                />
                                                                <InputField
                                                                        label="Series Name"
                                                                        name="seriesName"
                                                ...
                                                <div className="bg-white p-4 border border-slate-100">
                                                        ...
                                                        <div className="flex flex-wrap gap-x-4">
                                                                ...
                                                                <InputField
                                                                        ...
                                                                        name="durationInDays"
                                                                        rules={[{ required: true, message: "Please enter the duration in days" }]} type="number"
                                                                />
                                                                <InputField
                                                ...
                                                <div className="bg-white p-4 border border-slate-100 w-full">
                                                        <h2 className="mb-3 text-sm font-semibold uppercase tracking-wide text-red-500">
                                                        ...
                                                        <div className="flex flex-wrap gap-x-4 w-full">
                                                                <InputField
                                                                        ...
                                                                        rules={[{ required: true, message: "Please enter the drawer message title" }]}
                                                                />
                                                                ...
                                                                <InputField
                                                                        ...
                                                                        type="textarea"
                                                                        itemClassName="!w-full"
                                                                        rules={[{ required: true, message: "Please enter the drawer message description" }]}
                                                                />
                                                                <Divider />
                                                                <InputField
                                                                        label="Button Label"
                                                                        name="button"
                                                                        rules={[{ required: true, message: "Please enter the drawer message button text" }]}
                                                                />
                                                                <InputField
                                                                        label="Navigation"
                                                                        name="navigation"
